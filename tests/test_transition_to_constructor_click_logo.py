...
logo_link = driver.find_element(By.XPATH, ".//div[contains(@class, 'AppHeader_header__logo')]")
logo_link.click()

WebDriverWait(driver, 5).until(expected_conditions.visibility_of_element_located(
    (By.XPATH, ".//section[contains(@class, 'BurgerIngredients_ingredients')]")))

constructor_header = driver.find_element(
    By.XPATH, ".//section[contains(@class, 'BurgerIngredients_ingredients')]/h1")
